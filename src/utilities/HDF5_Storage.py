...
"""Unified HDF5 storage helpers for protein embeddings and alignment networks."""
...
# ---------------------------------------------------------------------------
# Protein Embedding HDF5 Specifications and Utilities
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Alignment Network HDF5 Specifications and Utilities
# ---------------------------------------------------------------------------
...
__all__ = [
    ...
    "REQUIRED_ATTRIBUTES",
    "REQUIRED_OBJECTS",
    "SANITIZED_RESIDUE_CODES",
    "EmbeddingManifest",
    "decode_string_dataset",
    "dtype_for_saving_mode",
    "saving_mode_for_dtype",
