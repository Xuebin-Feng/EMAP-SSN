...
class LauncherStructureTests(unittest.TestCase):
    def test_desktop_launchers_show_then_dismiss_and_keep_direct_diagnostics(self):
        ...
        install_command = (PROJECT_ROOT / "install.command").read_text(encoding="utf-8")
        ...
        self.assertIn("SSN Viewer.app", install_command)
        self.assertIn("SSN Tools.app", install_command)
